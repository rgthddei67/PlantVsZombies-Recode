...
description: 2026-08-10 5-9 屋脊督军完整首领；12000 生命、6/4秒渐强召唤、10秒突击令、抗黄油连控与改天技能
metadata:
  node_type: memory
  type: project
...
指挥契约：登场 1 秒生成首批，此后生命不低于 4000 时每 6 秒生成 3 只，低于 4000 时每 4 秒生成
...
`Board::CanSpawnZombieInRow`，所以泳池专属形态不会被硬塞到 5-9 屋顶。生命不低于 8000 时只抽标准池；
从 7999 降到 4000 的过程中，每个位置抽取高威胁池的概率由 30% 线性升至 100%，低于 4000 后固定
