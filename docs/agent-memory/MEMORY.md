...
- [第八大关机枪射手与极光树桩](project_pvz_gatling_aurora_torchwood.md) — 2026-08-29 机枪射手为 8-2 奖励的 225/30/300 紫卡四连发；极光树桩为 8-3 奖励的 225/30/300 火炬紫卡，把审定豌豆转为 50 伤、最多四个稳定不同目标的极光弹；最后转换器决定当前弹型，原发谱系与命中历史跨转换/对象池/存档保留
