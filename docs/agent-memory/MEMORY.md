...
- [第八大关极光祭司、极夜钟匠与终盘植物](project_pvz_area8_rift_clockwork_finale.md) — 2026-08-29 已实现 8-7/8-8：极光祭司提交3/白毛风4个独立裂隙，界碑花每15秒蓄1枚且最多2枚、以单枚改道一个离散入场；极夜钟匠记录同/邻行最多12只并在6秒后恢复或同ID复活，曙光莲按三红仪表充能并一次结算1200逐行伤害、封穴出土与8秒导航；全部 Board 事务、不可逆死亡/磁吸装备例外、存档及高密度复合粒子已闭环
