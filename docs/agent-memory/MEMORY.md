...
- [第九大关幽晶矿场](project_pvz_gloomcrystal_mine.md) — 2026-09-05 主人逐项批准固定矿道、75阳光/8秒单格开凿、无环最短路径、岩壁射界与精致矿洞美术；已实现9-1与公共地图机制；矿道工具仅开战显示、岩壁不盖选卡、施工进度置于岩壁上方，clang-release可见专项与独立防环测试通过；9-2开凿僵尸留待另一任务
