...
- [GameMessageBox Builder 与 UIManager 模态生命周期](project_pvz_messagebox_builder.md) — 2026-09-05 标准框 FZJT 字体、黄色黑边、480×282 短确认框（原尺寸 80%）与顶部文字布局；两处 OpenMenu 通过 ControlFont 单独换字，其他绘字默认值不变；长文自适应、资源加载与取消按钮验证
