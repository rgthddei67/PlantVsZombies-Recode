...
**目标：** 实现金黄色高级冰车、三路黄色冰道、本行碾压、速度场叠层、无伤阶梯加速、特殊植物克制和冒险 3-6 编排。

**技术路线：** 派生普通冰车并分别虚拟化铺冰/车速/碾压行范围；Board 独立持有黄色冰道环境状态；通用僵尸速度层按活车来源计层；独立换色资源与可观测 AutoTest 完成验收。
...
- [x] 三路铺冰与攻击范围分离；黄色冰道覆盖本行及相邻行，车辆只碾压本行植物。
