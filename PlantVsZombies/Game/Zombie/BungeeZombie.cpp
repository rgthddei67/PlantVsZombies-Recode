...
namespace {
	...
	constexpr float kCargoOffsetX = -20.0f;                 // 被提植物对齐蹦极双手中心的水平视觉偏移，单位 px
	constexpr float kCargoOffsetY = -12.0f;                 // 被提植物相对目标格的垂直视觉偏移，单位 px
	constexpr float kCordOffsetX = 51.0f;                   // 绳索相对僵尸视觉原点的水平偏移，单位 px
	constexpr float kCordEndOffsetY = 24.0f;                // 绳索向下延伸进身体背后的固定点，单位 px
