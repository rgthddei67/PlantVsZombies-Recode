...
namespace ResourceKeys
{
	namespace Textures
	{
		...
		RKEY(IMAGE_REANIM_ALARMBELLFLOWER_HEAD_READY);
		RKEY(IMAGE_REANIM_ALARMBELLFLOWER_HEAD_RINGING);
		RKEY(IMAGE_REANIM_ALARMBELLFLOWER_HEAD_FADING);
		RKEY(IMAGE_REANIM_ALARMBELLFLOWER_CLAPPER);
		RKEY(IMAGE_REANIM_ALARMBELLFLOWER_BASE);
