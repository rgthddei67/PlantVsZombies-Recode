...
namespace ResourceKeys
{
	namespace Textures
	{
		...
		const std::string IMAGE_FLAG_METER = "IMAGE_FLAGMETER_PART_0";
		const std::string IMAGE_FLAG_METERFULL = "IMAGE_FLAGMETER_PART_1";
		const std::string IMAGE_FLAGMETERLEVELPROGRESS = "IMAGE_FLAGMETERLEVELPROGRESS";
		const std::string IMAGE_FLAGMETER_PART_HEAD = "IMAGE_FLAGMETERPARTS_PART_0";
		const std::string IMAGE_FLAGMETER_PART_STICK = "IMAGE_FLAGMETERPARTS_PART_1";
		const std::string IMAGE_FLAGMETER_PART_FLAG = "IMAGE_FLAGMETERPARTS_PART_2";
		...
		const std::string IMAGE_ZOMBIE_BALLOON_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_BALLOON_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_BOBSLED_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_BOBSLED_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_BOSS_ARM_UPPER2 = "IMAGE_ZOMBIE_BOSS_ARM_UPPER2";
		const std::string IMAGE_ZOMBIE_BUNGI_LEFTARM_UPPER2 = "IMAGE_ZOMBIE_BUNGI_LEFTARM_UPPER2";
		const std::string IMAGE_ZOMBIE_BUNGI_RIGHTARM_UPPER2 = "IMAGE_ZOMBIE_BUNGI_RIGHTARM_UPPER2";
		const std::string IMAGE_ZOMBIE_DIGGER_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_DIGGER_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_DISCO_OUTERARM_UPPER_BONE = "IMAGE_ZOMBIE_DISCO_OUTERARM_UPPER_BONE";
		const std::string IMAGE_ZOMBIE_DOLPHINRIDER_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_DOLPHINRIDER_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_FOOTBALL_LEFTARM_UPPER2 = "IMAGE_ZOMBIE_FOOTBALL_LEFTARM_UPPER2";
		const std::string IMAGE_ZOMBIE_JACKSON_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_JACKSON_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_LADDER_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_LADDER_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_PAPER_LEFTARM_UPPER2 = "IMAGE_ZOMBIE_PAPER_LEFTARM_UPPER2";
		const std::string IMAGE_ZOMBIE_POGO_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_POGO_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_POLEVAULTER_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_POLEVAULTER_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_SNORKLE_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_SNORKLE_OUTERARM_UPPER2";
		const std::string IMAGE_ZOMBIE_YETI_OUTERARM_UPPER2 = "IMAGE_ZOMBIE_YETI_OUTERARM_UPPER2";

		const std::string IMAGE_PROJECTILECACTUS = "IMAGE_PROJECTILECACTUS";
		const std::string IMAGE_PROJECTILEPEA = "IMAGE_PROJECTILEPEA";
	...
	namespace Particles
	{
		const std::string PARTICLE_ZOMBIE_HEAD = "PARTICLE_ZOMBIEHEAD";
		const std::string PARTICLE_EXPLOSIONCLOUD = "PARTICLE_EXPLOSIONCLOUD";
		const std::string PARTICLE_ZOMBIE_BACKUPDANCERHEAD = "PARTICLE_ZOMBIEBACKUPDANCERHEAD";
		const std::string PARTICLE_ZOMBIE_BACKUPDANCERHEAD_DISCO = "PARTICLE_ZOMBIEBACKUPDANCERHEAD_DISCO";
		const std::string PARTICLE_ZOMBIE_BOBSLEDHEAD = "PARTICLE_ZOMBIEBOBSLEDHEAD";
		const std::string PARTICLE_ZOMBIE_DANCERHEAD = "PARTICLE_ZOMBIEDANCERHEAD";
		const std::string PARTICLE_ZOMBIE_DANCERHEAD_DISCO = "PARTICLE_ZOMBIEDANCERHEAD_DISCO";
		const std::string PARTICLE_ZOMBIE_DIGGERARM = "PARTICLE_ZOMBIEDIGGERARM";
		const std::string PARTICLE_ZOMBIE_DIGGERHEAD = "PARTICLE_ZOMBIEDIGGERHEAD";
		const std::string PARTICLE_ZOMBIE_DOLPHINRIDERHEAD = "PARTICLE_ZOMBIEDOLPHINRIDERHEAD";
		const std::string PARTICLE_ZOMBIE_FOOTBALLHEAD = "PARTICLE_ZOMBIEFOOTBALLHEAD";
		const std::string PARTICLE_ZOMBIE_IMPHEAD = "PARTICLE_ZOMBIEIMPHEAD";
		const std::string PARTICLE_ZOMBIE_LADDERHEAD = "PARTICLE_ZOMBIELADDERHEAD";
		const std::string PARTICLE_ZOMBIE_POGOHEAD = "PARTICLE_ZOMBIEPOGOHEAD";
	...
	namespace Music
	{
		...
		const std::string MUSIC_CHOOSEYOURSEEDS = "MUSIC_CHOOSEYOURSEEDS";
		const std::string MUSIC_DAY = "MUSIC_DAY";
		const std::string MUSIC_FOG = "MUSIC_FOG";
		const std::string MUSIC_LOONBOON = "MUSIC_LOONBOON";
		const std::string MUSIC_NIGHT = "MUSIC_NIGHT";
		const std::string MUSIC_POOL = "MUSIC_POOL";
		const std::string MUSIC_ROOF = "MUSIC_ROOF";
	...
	namespace Reanimations
	{
		...
		const std::string REANIM_SNOWPEASHOOTER = "SnowPeaShooter";
		...
		const std::string REANIM_BUCKET_ZOMBIE = "BucketZombie";
